...
const FragmentCard = ({ fragment, isActiveFragment, onFragmentClick }: FragmentCardProps) => {
    return (
        <button className={cn(
            "flex items-start text-start gap-2 rounded-lg border p-3 bg-muted hover:bg-secondary transition-colors",
        ...
        <div className={cn(
            ...
            <div className='flex items-center gap-2 pl-2 mb-2'>
                <Image 
                    ...
                    className='shrink-0'
                />
                <span className='text-sm font-medium'>Architeck AI</span>
